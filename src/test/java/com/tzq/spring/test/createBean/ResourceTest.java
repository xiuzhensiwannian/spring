package com.tzq.spring.test.createBean;
...
import com.tzq.spring.beans.factory.xml.XmlBeanDefinitionReader;
import com.tzq.spring.core.io.DefaultResourceLoader;
import com.tzq.spring.core.io.Resource;
import com.tzq.spring.test.UserDao;
import com.tzq.spring.test.UserService;
...
public class ResourceTest {
    ...
    public void test_BeanFactory() {
        ...
        String result = userService.queryUserInfo(userService.getUId());
